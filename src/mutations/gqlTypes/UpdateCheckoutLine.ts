...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_tags {
  __typename: "TagType";
  /**
   * The name of the tag
   */
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product_tags {
  __typename: "TagType";
  /**
   * The name of the tag
   */
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product {
   ...
   * Tags
   */
  tags: (UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product_tags | null)[] | null;
  /**
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant {
   ...
   */
  tags: (UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_tags | null)[] | null;
  /**
