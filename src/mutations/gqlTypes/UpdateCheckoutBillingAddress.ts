...
export interface UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout_lines_variant_tags {
  __typename: "TagType";
  /**
   * The name of the tag
   */
...
export interface UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout_lines_variant_metadata {
...
export interface UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout_lines_variant_product_tags {
  __typename: "TagType";
  /**
   * The name of the tag
   */
...
export interface UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout_lines_variant_product {
   ...
   * Tags
   */
  tags: (UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout_lines_variant_product_tags | null)[] | null;
  /**
...
export interface UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout_lines_variant {
   ...
   */
  tags: (UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout_lines_variant_tags | null)[] | null;
  /**
   ...
   */
  metadata: (UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout_lines_variant_metadata | null)[];
  /**
