...
export class ApolloClientManager {
  ...
  checkoutLineExpressAdd = async (checkoutLineId: string, price: string) => {
    try {
      ...
      if (data?.checkoutLineExpressAdd?.cart) {
        return {
          data: data.checkoutLineExpressAdd.cart,
        };
      }
    } catch (error) {
      return {
  ...
  checkoutLineExpressRemove = async (checkoutLineId: string) => {
    try {
      ...
      if (data?.checkoutLineExpressRemove?.cart) {
        return {
          data: data.checkoutLineExpressRemove.cart,
        };
      }
    } catch (error) {
      return {
