...
export interface UserCheckoutDetails_me_checkout_lines_variant_tags {
  __typename: "TagType";
  /**
   * The name of the tag
   */
...
export interface UserCheckoutDetails_me_checkout_lines_variant_metadata {
...
export interface UserCheckoutDetails_me_checkout_lines_variant_product_tags {
  __typename: "TagType";
  /**
   * The name of the tag
   */
...
export interface UserCheckoutDetails_me_checkout_lines_variant_product {
   ...
   * Tags
   */
  tags: (UserCheckoutDetails_me_checkout_lines_variant_product_tags | null)[] | null;
  /**
...
export interface UserCheckoutDetails_me_checkout_lines_variant {
   ...
   */
  tags: (UserCheckoutDetails_me_checkout_lines_variant_tags | null)[] | null;
  /**
   ...
   */
  metadata: (UserCheckoutDetails_me_checkout_lines_variant_metadata | null)[];
  /**
