...
class SaleorState extends helpers_1.NamedObservable {
    constructor(localStorageHandler, apolloClientManager, jobsManager) {
        super();
        /**
        ...
        this.loadWishlist = () => {
            this.localStorageHandler.subscribeToChange(LocalStorageHandler_1.LocalStorageItems.WISHLIST, this.onWishlistUpdate);
        };
        /**
        ...
        this.initializeState = (config) => __awaiter(this, void 0, void 0, function* () {
             ...
             */
            const signInToken = yield async_storage_1.default.getItem("token");
            const csrfToken = yield async_storage_1.default.getItem("csrf_token");
            if (signInToken) {
            ...
            if (config.loadOnStart.checkout) {
                ...
                const getPayment = yield LocalStorageHandler_1.LocalStorageHandler.getPayment();
        ...
        this.refreshToken = () => __awaiter(this, void 0, void 0, function* () {
            var _b;
            const { data, dataError } = yield this.jobsManager.run("auth", "refreshSignInToken", { refreshToken: undefined });
            if (dataError) {
                yield this.jobsManager.run("auth", "signOut", undefined);
                try {
                    if ((_b = navigator.credentials) === null || _b === void 0 ? void 0 : _b.preventSilentAccess) {
                        yield navigator.credentials.preventSilentAccess();
                    }
                }
                catch (credentialsError) {
        ...
        this.onWishlistUpdate = (wishlist) => {
            this.wishlist = wishlist;
            this.notifyChange(types_1.StateItems.WISHLIST, this.wishlist);
        };
    ...
    static create(config, localStorageHandler, apolloClientManager, jobsManager) {
        return __awaiter(this, void 0, void 0, function* () {
            const saleorState = new SaleorState(localStorageHandler, apolloClientManager, jobsManager);
            const signInToken = yield LocalStorageHandler_1.LocalStorageHandler.getSignInToken();
            saleorState.onSignInTokenUpdate(signInToken);
            saleorState.subscribeStateToChanges();
            yield saleorState.initializeState(config);
            return saleorState;
        });
    }
