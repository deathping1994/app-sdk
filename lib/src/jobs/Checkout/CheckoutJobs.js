...
class CheckoutJobs extends JobsHandler_1.JobsHandler {
    constructor(localStorageHandler, apolloClientManager) {
        ...
        this.provideCheckout = ({ isUserSignedIn, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const checkout = yield LocalStorageHandler_1.LocalStorageHandler.getCheckout();
            ...
            yield this.localStorageHandler.setCheckout(data || checkout);
            // const data={};
            return {
                data,
            };
        ...
        this.setAddressType = ({ addressId, type, }) => __awaiter(this, void 0, void 0, function* () {
            const { data, error } = yield this.apolloClientManager.setAddressType(addressId, type);
            if (error) {
                return {
                    dataError: {
                        error,
        ...
        this.createCheckout = ({ email, lines, shippingAddress, selectedShippingAddressId, billingAddress, selectedBillingAddressId, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.localStorageHandler.setCheckout(Object.assign(Object.assign({}, data), { selectedBillingAddressId,
        ...
        this.setBillingAddress = ({ checkoutId, billingAddress, billingAsShipping, selectedBillingAddressId, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.localStorageHandler.setCheckout(Object.assign(Object.assign({}, ((checkout === null || checkout === void 0 ? void 0 : checkout._W) ? checkout === null || checkout === void 0 ? void 0 : checkout._W : checkout)), { availablePaymentGateways: data === null || data === void 0 ? void 0 : data.availablePaymentGateways, billingAddress: data === null || data === void 0 ? void 0 : data.billingAddress, billingAsShipping: !!billingAsShipping, selectedBillingAddressId }));
            return { data };
        });
        ...
        this.updateCheckoutPayment = ({ checkoutId, gatewayId, useCashback, }) => __awaiter(this, void 0, void 0, function* () {
            const checkout = LocalStorageHandler_1.LocalStorageHandler.getCheckout();
            const { data, error, } = yield this.apolloClientManager.updateCheckoutPayment(checkoutId, gatewayId, useCashback);
            if (error) {
                return {
                    dataError: {
                        error,
            ...
            yield this.localStorageHandler.setCheckout(Object.assign(Object.assign({}, data), { promoCodeDiscount: data === null || data === void 0 ? void 0 : data.promoCodeDiscount, shippingMethod: data === null || data === void 0 ? void 0 : data.shippingMethod, availableShippingMethods: data === null || data === void 0 ? void 0 : data.availableShippingMethods, shippingAddress: data === null || data === void 0 ? void 0 : data.shippingAddress }));
            return { data };
        });
        this.setShippingMethod = ({ checkoutId, shippingMethodId, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.localStorageHandler.setCheckout(Object.assign(Object.assign({}, data), { promoCodeDiscount: data === null || data === void 0 ? void 0 : data.promoCodeDiscount, shippingMethod: data === null || data === void 0 ? void 0 : data.shippingMethod }));
            return { data };
        });
        this.addPromoCode = ({ checkoutId, promoCode, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.localStorageHandler.setCheckout(Object.assign(Object.assign({}, ((checkout === null || checkout === void 0 ? void 0 : checkout._W) ? checkout === null || checkout === void 0 ? void 0 : checkout._W : checkout)), { promoCodeDiscount: data === null || data === void 0 ? void 0 : data.promoCodeDiscount }));
            return { data };
        });
        ...
        this.createPayment = ({ checkoutId, amount, gateway, token, billingAddress, creditCard, returnUrl, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.localStorageHandler.setPayment(Object.assign(Object.assign({}, payment), { creditCard, gateway: data === null || data === void 0 ? void 0 : data.gateway, id: data === null || data === void 0 ? void 0 : data.id, token: data === null || data === void 0 ? void 0 : data.token, total: data === null || data === void 0 ? void 0 : data.total }));
            return { data };
        });
        this.completeCheckout = ({ checkoutId, paymentData, redirectUrl, storeSource, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(data === null || data === void 0 ? void 0 : data.confirmationNeeded)) {
                yield this.localStorageHandler.setCheckout({});
                yield this.localStorageHandler.setPayment({});
            }
            return { data };
        });
