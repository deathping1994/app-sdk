...
export interface UpdateCheckoutShippingAddress_checkoutShippingAddressUpdate_checkout_lines_variant_tags {
    __typename: "TagType";
    /**
     * The name of the tag
     */
...
export interface UpdateCheckoutShippingAddress_checkoutShippingAddressUpdate_checkout_lines_variant_product_tags {
    __typename: "TagType";
    /**
     * The name of the tag
     */
...
export interface UpdateCheckoutShippingAddress_checkoutShippingAddressUpdate_checkout_lines_variant_product {
     ...
     * Tags
     */
    tags: (UpdateCheckoutShippingAddress_checkoutShippingAddressUpdate_checkout_lines_variant_product_tags | null)[] | null;
    /**
...
export interface UpdateCheckoutShippingAddress_checkoutShippingAddressUpdate_checkout_lines_variant {
     ...
     */
    tags: (UpdateCheckoutShippingAddress_checkoutShippingAddressUpdate_checkout_lines_variant_tags | null)[] | null;
    /**
     ...
     */
    metadata: (UpdateCheckoutShippingAddress_checkoutShippingAddressUpdate_checkout_lines_variant_metadata | null)[];
    /**
...
export interface UpdateCheckoutShippingAddress_checkoutEmailUpdate_checkout_lines_variant_tags {
    __typename: "TagType";
    /**
     * The name of the tag
     */
...
export interface UpdateCheckoutShippingAddress_checkoutEmailUpdate_checkout_lines_variant_product_tags {
    __typename: "TagType";
    /**
     * The name of the tag
     */
...
export interface UpdateCheckoutShippingAddress_checkoutEmailUpdate_checkout_lines_variant_product {
     ...
     * Tags
     */
    tags: (UpdateCheckoutShippingAddress_checkoutEmailUpdate_checkout_lines_variant_product_tags | null)[] | null;
    /**
     * The main thumbnail for a product.
     */
...
export interface UpdateCheckoutShippingAddress_checkoutEmailUpdate_checkout_lines_variant {
     ...
     * List of tags associated with the product variant
     */
    tags: (UpdateCheckoutShippingAddress_checkoutEmailUpdate_checkout_lines_variant_tags | null)[] | null;
    /**
     * Quantity of a product available for sale in one checkout.
     */
    quantityAvailable: number;
     ...
     * List of public metadata items. Can be accessed without permissions.
     */
    metadata: (UpdateCheckoutShippingAddress_checkoutEmailUpdate_checkout_lines_variant_metadata | null)[];
    /**
     * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
     */
