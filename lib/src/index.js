...
class SaleorManager {
    constructor(config, apolloConfig, appversion, appplatform) {
    ...
    connect(apiChangeListener) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.api || !this.apiProxy || !this.apolloClient) {
                const { api, apiProxy, apolloClient } = yield SaleorManager.createApi(this.config, this.apolloConfig, this.tokenExpirationCallback, this.onSaleorApiChange, this.appplatform, this.appversion);
                this.api = api;
...
SaleorManager.createApi = (config, apolloConfig, tokenExpirationCallback, onSaleorApiChange, appplatform, appversion) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const api = yield api_1.SaleorAPI.create(apolloClient, apiProxy, config, onSaleorApiChange);
