...
const useQuery = (query, variables = {}, options = {}) => {
    ...
    const setData = react_1.default.useCallback((data, loading) => {
        if (!equality_1.default(data, prevDataRef.current)) {
    ...
    const { unsubscribe, setOptions, 
    /* eslint-disable @typescript-eslint/naming-convention */
    refetch: _refetch, loadMore: _loadMore, } = react_1.default.useMemo(() => saleor.legacyAPIProxy[query](variables, Object.assign(Object.assign({}, options), { onError: (error) => setResult(previousResult => (Object.assign(Object.assign({}, previousResult), { error, loading: false }))), onUpdate: (data, loading) => {
