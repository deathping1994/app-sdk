...
export declare const mutationFactory: <T extends "client" | "getAttributes" | "getOrdersByUser" | "getOrderDetails" | "getVariantsProducts" | "getShopDetails" | "setUserDefaultAddress" | "setDeleteUserAddress" | "setCreateUserAddress" | "setUpdateuserAddress" | "setAccountUpdate" | "setPassword" | "setPasswordChange" | "attachAuthListener" | "isLoggedIn" | "watchQuery" | "fireQuery", TVariables extends Variables<T>, TOptions extends Options<T>>(mutation: T) => (variables?: TVariables, options?: TOptions) => [MutationFn<ReturnData<T>, TVariables>, MutationResult<ReturnData<T>>];
export {};
