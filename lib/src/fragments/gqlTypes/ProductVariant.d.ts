export interface ProductVariant_tags {
    __typename: "TagType";
    /**
     * The name of the tag
     */
...
export interface ProductVariant_product_tags {
    __typename: "TagType";
    /**
     * The name of the tag
     */
...
export interface ProductVariant_product {
     ...
     * Tags
     */
    tags: (ProductVariant_product_tags | null)[] | null;
    /**
...
export interface ProductVariant {
     ...
     */
    tags: (ProductVariant_tags | null)[] | null;
    /**
